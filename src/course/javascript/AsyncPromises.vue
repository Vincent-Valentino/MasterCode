<template>
  <div class="container mx-auto p-4">
    ...
    <div class="w-full flex items-center gap-2 bg-yellow-500 rounded-t-xl p-4">
      ...
      <h1 class="text-2xl md:text-4xl font-bold text-white">Async Promise</h1>
    </div>
    ...
    <nav class="mb-8">
      ...
      <ul class="list-disc list-inside text-blue-500">
        <li><a href="#introduction" class="underline">1. Introduction to Asynchronous JavaScript</a></li>
        <li><a href="#why-async" class="underline">2. Why Asynchronous Programming?</a></li>
        <li><a href="#callbacks" class="underline">3. The Callback Hell</a></li>
        <li><a href="#promises" class="underline">4. Understanding Promises</a></li>
        <li><a href="#creating-promises" class="underline">5. Creating Promises</a></li>
        <li><a href="#consuming-promises" class="underline">6. Consuming Promises with then() and catch()</a></li>
        <li><a href="#chaining-promises" class="underline">7. Chaining Promises</a></li>
        <li><a href="#error-handling" class="underline">8. Error Handling in Promises</a></li>
        <li><a href="#promise-all-race" class="underline">9. Promise.all and Promise.race</a></li>
        <li><a href="#async-await" class="underline">10. Async/Await: Syntactic Sugar over Promises</a></li>
        <li><a href="#practical-examples" class="underline">11. Practical Examples</a></li>
        <li><a href="#best-practices" class="underline">12. Best Practices</a></li>
        <li><a href="#common-mistakes" class="underline">13. Common Mistakes</a></li>
        <li><a href="#summary" class="underline">14. Summary</a></li>
      </ul>
    </nav>

    <!-- Content Sections -->
    <section id="introduction" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">1. Introduction to Asynchronous JavaScript</h2>
      ...
      <p class="text-lg text-gray-700">
        This guide explores asynchronous programming concepts in JavaScript, focusing on Promises—a modern and powerful tool for managing asynchronous operations.
      </p>
    </section>

    <section id="why-async" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">2. Why Asynchronous Programming?</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="callbacks" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">3. The Callback Hell</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="promises" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">4. Understanding Promises</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="creating-promises" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">5. Creating Promises</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="consuming-promises" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">6. Consuming Promises with then() and catch()</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="chaining-promises" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">7. Chaining Promises</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="error-handling" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">8. Error Handling in Promises</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="promise-all-race" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">9. Promise.all and Promise.race</h2>
      <p class="text-lg text-gray-700 mb-4">
      ...
      <p class="text-lg text-gray-700 mb-4"><strong>Example of Promise.all:</strong></p>
      <div class="bg-gray-800 text-white rounded-lg p-4 mb-4 overflow-auto">
      ...
      <p class="text-lg text-gray-700 mb-4"><strong>Example of Promise.race:</strong></p>
      <div class="bg-gray-800 text-white rounded-lg p-4 mb-4 overflow-auto">
    ...
    <section id="async-await" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">10. Async/Await: Syntactic Sugar over Promises</h2>
      <p class="text-lg text-gray-700 mb-4">
      ...
      <p class="text-lg text-gray-700 mb-4"><strong>Basic Async/Await Example:</strong></p>
      <div class="bg-gray-800 text-white rounded-lg p-4 mb-4 overflow-auto">
        <pre><code class="language-javascript">{{ asyncAwaitExample }}</code></pre>
      </div>
      <p class="text-lg text-gray-700 mb-4">
        <strong>Explanation:</strong> The <code>fetchData</code> function is declared as async, allowing the use of <code>await</code> to wait for the promise returned by <code>getData</code> to resolve.
      </p>
      <p class="text-lg text-gray-700 mb-4"><strong>Error Handling with Async/Await:</strong></p>
      <div class="bg-gray-800 text-white rounded-lg p-4 mb-4 overflow-auto">
    ...
    <section id="practical-examples" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">11. Practical Examples</h2>
      <p class="text-lg text-gray-700 mb-4">
      ...
      <div class="mb-12">
        <h3 class="text-2xl font-semibold mb-2">11.1. Fetching Data from an API</h3>
        <p class="text-lg text-gray-700 mb-4">
      ...
      <div class="mb-12">
        <h3 class="text-2xl font-semibold mb-2">11.2. Handling Multiple Asynchronous Operations</h3>
        <p class="text-lg text-gray-700 mb-4">
        ...
        <p class="text-lg text-gray-700 mb-4">
          <strong>Explanation:</strong> <code>Promise.all</code> waits for all provided promises to resolve. If any promise rejects, the entire <code>Promise.all</code> rejects.
        </p>
        <div class="bg-gray-100 rounded-lg p-4 mb-6 overflow-auto">
      ...
      <div class="mb-12">
        <h3 class="text-2xl font-semibold mb-2">11.3. Implementing Retry Logic</h3>
        <p class="text-lg text-gray-700 mb-4">
      ...
      <div class="mb-12">
        <h3 class="text-2xl font-semibold mb-2">11.4. Sequential API Calls</h3>
        <p class="text-lg text-gray-700 mb-4">
      ...
      <div class="mb-12">
        <h3 class="text-2xl font-semibold mb-2">11.5. Timeout with Promises</h3>
        <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="best-practices" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">12. Best Practices</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="common-mistakes" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">13. Common Mistakes</h2>
      <p class="text-lg text-gray-700 mb-4">
    ...
    <section id="summary" class="mb-12">
      <h2 class="text-3xl font-semibold mb-4">14. Summary</h2>
      <p class="text-lg text-gray-700 mb-4">
