<template>
  <div class="w-full">
    ...
    <div class="w-full flex items-center gap-5 bg-blue-950 rounded-t-xl p-4">
      ...
      <h1 class="text-2xl md:text-4xl font-bold text-blue-200">TypeScript and JavaScript interoperability</h1>
    </div>

    <!-- Section: Understanding JavaScript Compatibility -->
    <section id="js-compatibility" class="bg-white rounded-b-xl p-4 md:p-6">
      <h2 class="text-xl md:text-2xl font-semibold mb-4">Understanding JavaScript Compatibility</h2>
...
console.log(greet('Alice')); // Output: Hello, Alice!</code></pre>
    ...
    <section id="js-libraries" class="bg-white rounded-b-xl p-4 md:p-6 mt-6">
      <h2 class="text-xl md:text-2xlfont-semibold mb-4">Working with JavaScript Libraries in TypeScript</h2>
      <p class="text-base md:text-lg mb-6">
...
declare module 'some-library' {
  export function doSomething(): void;
    ...
    <section id="types-handling" class="bg-white rounded-b-xl p-4 md:p-6 mt-6">
      <h2 class="text-xl md:text-2xlfont-semibold mb-4">Using @types to Handle Type Definitions</h2>
      <p class="text-base md:text-lg mb-6">
...
$('#element').hide();</code></pre>
    ...
    <section id="migrating-js-to-ts" class="bg-white rounded-b-xl p-4 md:p-6 mt-6">
      <h2 class="text-xl md:text-2xlfont-semibold mb-4">Migrating a JavaScript Project to TypeScript</h2>
      <p class="text-base md:text-lg mb-6">
