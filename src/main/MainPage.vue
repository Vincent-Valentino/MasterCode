<template>
  <div class="min-h-screen bg-white text-gray-800">
    ...
    <div class="flex flex-col md:flex-row md:pl-4 bg-slate-50">
      <!-- Main content area -->
      <div :class="!isMobile.valueOf ? 'w-[60%]' : 'w-full'">
      ...
      <div :class="selectedCourse && selectedCourse !== 'Home' ? 'w-full md:w-[35%] h-auto md:mt-10 md:mr-5' : 'hidden md:block w-0'">
        <MainSidebar 
          v-if="selectedCourse" 
